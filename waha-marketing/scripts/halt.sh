...
#   skill-waha-marketing/scripts/emergency-halt.sh   (/tmp/waha-broadcast-halt)
#   skill-email-marketing/scripts/emergency-halt.sh  (/tmp/hermes-email-halt)
#
...
[[ -f "$LIB" ]] || LIB="$HERE/../../shared/lib/halt.py"
