...
checks were written in `email-marketing/lib/mailbox.py`, and for a while that
...
installed independently — `waha-marketing` must work when `email-marketing` is
...
# Kept byte-identical to skill-email-marketing/lib/mailbox.py — the two
