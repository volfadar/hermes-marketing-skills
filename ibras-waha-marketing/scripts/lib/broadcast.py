...
# Kill-switch. The canonical switch is shared (`scripts/lib/halt.py`) so that ONE command
...
def check_halt() -> bool:
    ...
    if _HALT_LIB is not None:
        try:
            ...
            return True  # cannot tell -> treat as halted; see shared/scripts/lib/halt.py
