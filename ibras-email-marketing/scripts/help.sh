...
cat <<'TXT'
ibras-email-marketing — kirim, baca, dan balas email lewat Gmail SMTP/IMAP
...
BALASAN OTOMATIS — bertahap, jangan langsung penuh
  ...
  python3 scripts/lib/handoff.py list              antrean yang perlu kamu jawab sekali
  python3 scripts/lib/handoff.py answer 1 --text "..."   jawab, lalu masuk FAQ
...
SEBELUM MENGIRIM APA PUN
  python3 scripts/lib/copycheck.py <draft>          lolos uji tukar?
