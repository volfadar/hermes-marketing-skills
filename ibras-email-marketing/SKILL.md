...
metadata:
  hermes:
    ...
    related_skills: [ibras-waha-marketing, ibras-social-publishing, ibras-brand-strategy-coach]
---
...
```bash
python3 scripts/lib/handoff.py list                    # antrean, satu baris per orang
python3 scripts/lib/handoff.py answer 1 --text "..."   # jawab sekali
python3 scripts/lib/handoff.py stats                   # yang paling sering naik
```
...
0. **Cek koneksi sebelum bertanya apa pun.** `bash scripts/mail.sh stats`.
   ...
   Sekalian: `python3 scripts/lib/ledger.py open` (ada yang belum kelar dari kemarin?)
   dan `python3 scripts/lib/profile.py show` (harga, jam buka, apa yang boleh
...
- [examples/answers.example.json](examples/answers.example.json)
...
- [references/faq-guide.md](references/faq-guide.md)
- [references/gmail-setup.md](references/gmail-setup.md)
...
- [scripts/autoreply.sh](scripts/autoreply.sh)
...
- [scripts/lib/autoresponder.py](scripts/lib/autoresponder.py)
...
- [scripts/lib/mailbox.py](scripts/lib/mailbox.py)
...
- [templates/faq.example.yaml](templates/faq.example.yaml)
- [templates/profile.example.yaml](templates/profile.example.yaml)
- [templates/signature.example.txt](templates/signature.example.txt)
