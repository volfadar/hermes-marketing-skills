...
metadata:
  hermes:
    ...
    related_skills: [ibras-content-creator, ibras-waha-marketing, ibras-email-marketing, ibras-brand-strategy-coach]
---
...
- [assets/data/options.yaml](assets/data/options.yaml)
- [assets/data/platforms.yaml](assets/data/platforms.yaml)
- [assets/data/sources.yaml](assets/data/sources.yaml)

### examples

- [examples/percakapan-contoh.md](examples/percakapan-contoh.md)

### references

- [references/automation-posture.md](references/automation-posture.md)
- [references/browser-tailscale.md](references/browser-tailscale.md)
...
- [references/research-digest.md](references/research-digest.md)
- [references/tiers.md](references/tiers.md)
- [references/tools-mapping.md](references/tools-mapping.md)

### scripts

- [scripts/advise.sh](scripts/advise.sh)
...
- [scripts/lib/advisor.py](scripts/lib/advisor.py)
...
- [templates/pilot-2-minggu.md](templates/pilot-2-minggu.md)
