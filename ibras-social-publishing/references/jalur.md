...
Versi mesin dari halaman ini ada di `assets/data/options.yaml` — itu yang dibaca
`advisor.py`. Kalau kamu mengubah salah satu, ubah keduanya.

```bash
python3 scripts/lib/advisor.py options                  # ringkas
python3 scripts/lib/advisor.py show <id>                # lengkap + kerugian
python3 scripts/lib/advisor.py recommend --help         # urutkan sesuai batasanmu
```
