...
**diverifikasi 12 Agustus 2026**. Versi mesinnya di `assets/data/platforms.yaml`.

```bash
python3 scripts/lib/advisor.py platforms
python3 scripts/lib/advisor.py sources --id ig-content-publishing
```
...
`assets/data/platforms.yaml` menandai keduanya **BELUM DIVERIFIKASI**.
...
lalu perbarui `assets/data/platforms.yaml` dengan tanggal verifikasi baru.
