...
|---|---|---|
| **WhatsApp** | ❌ tidak ada di daftar platform mana pun | **`waha-marketing`** — WAHA, dengan rem pacing & opt-in yang sudah kita punya |
| **Email** | ❌ | **`email-marketing`** — Gmail SMTP + IMAP |
| Profil usaha, suara, batasan | ❌ | `profile.yaml` |
| Memutuskan kolam/positioning | ❌ | `brand-strategy-coach` |
| Riset halaman publik di luar TikTok/Threads | sebagian | `cloakserve-research` |
| Penjadwalan kerja agen, notepad, monitor-mode | ❌ | **Hermes sendiri** (`lib/watch.py`) |
