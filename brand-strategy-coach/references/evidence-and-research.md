...
Prefer the installed `cloakserve-research` skill for public market research. Read its `SKILL.md` before use and follow its ethics. If unavailable, use another web/browser tool.
