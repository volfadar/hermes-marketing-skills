...
## Fakta platform yang sudah diverifikasi (18 Agu 2026)
...
## Jalur install GitHub / skills.sh — hasil scan per skill (18 Agu 2026)
...
Semua 7 identifier pendek `volfadar/hermes-marketing-skills/ibras-*` sudah
**terverifikasi** pada Hermes Agent v0.20.2 (2026.8.16) di container Incus
Ubuntu bersih. Lock Hub mencatat source `skills.sh`, identifier lengkap
`skills-sh/volfadar/hermes-marketing-skills/ibras-*`, dan revision
`262abf42b39c73e4cce8af19d4551ccbadb08f94`. Lima SAFE dipasang langsung,
...
Tes model OpenRouter juga lulus: discovery tanpa preload menemukan tepat tujuh
nama `ibras-*`, sedangkan sesi yang mem-preload ketujuh skill mengembalikan
