...
3. **API tidak resmi = risiko akun**, dan itu risiko yang beda dari
   ...
   risiko itu sama sekali — lihat `skill-social-publishing` untuk enam jalur
...
hermes cron add "0 9 * * 1" "Pakai skill content-creator: ideate 5 konten dari pillars + riset tren minggu ini. Draft tiap konten untuk Instagram. Kirim DRAFT ke Telegram untuk saya review. JANGAN auto-publish ke Instagram." --name "Draft konten mingguan" --deliver telegram
```
