...
cp -R ibras-cloakserve-research ~/.hermes/skills/ibras-cloakserve-research

# Atau, kalau di-host via git:
hermes skills install <user>/hermes-marketing-skills/ibras-cloakserve-research
```
...
bash ~/.hermes/skills/ibras-cloakserve-research/scripts/initialize.sh

# Riset
bash ~/.hermes/skills/ibras-cloakserve-research/scripts/research.sh "kopi arabika"

# Diagnosa kalau ada masalah
bash ~/.hermes/skills/ibras-cloakserve-research/scripts/doctor.sh

# Stop
bash ~/.hermes/skills/ibras-cloakserve-research/scripts/stop.sh
```
